...
$srcPath = 'P:\FOTO SPETTACOLI\FOTO LAVORI\EXPO2030\ROME\NEW SITE\Unknown-1.png'
$destPath = 'C:\Users\vitto\cristiantaraborrelli.github.io\images\expo-roma-2030-abbagnato-aerial.jpg'
$maxDim = 1600
$quality = 80
...
Write-Host "OK: expo-roma-2030-abbagnato-aerial.jpg ($newW x $newH, ${finalSize}KB)"
